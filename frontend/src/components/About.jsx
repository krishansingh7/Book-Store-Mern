            ...
            <div className="flex flex-col items-center justify-between lg:flex-row py-16">
              <div className=" relative ">
                ...
                <div className="lg:max-w-xl lg:pr-5 relative z-40">
                  <h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                    Describe your way with good thought
                  ...
                  <p className="text-base text-gray-700">
                    ...
                    Magnam explicabo delectus beatae tenetur mollitia recusandae
                    consequatur illo consectetur quos tempore.
                  </p>
                  <div className="mt-10 flex flex-col items-center md:flex-row">
                    <Link
                      to="/"
                      className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-orange-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-orange-600 focus:outline-none md:mr-4 md:mb-0 md:w-auto"
                    >
                      Explore Books
                    </Link>
                    <a
              ...
              <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
                ...
                <div className="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                  <img
                    src="https://imgs.search.brave.com/-3uFp-OVCUbtJu73AcYdRGV_FnUIuRJGhWsfLx3tkyY/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9tZWRp/YS5nZXR0eWltYWdl/cy5jb20vaWQvMTM2/MDAyODA2Ni9waG90/by9sb29raW5nLWZv/ci1hLWJvb2suanBn/P3M9NjEyeDYxMiZ3/PTAmaz0yMCZjPWI1/NnJVcEF0NG5BcGNo/THlVUE5qZi1vVW1v/VGF0UkVsQ2xWazJ1/ZDlyUzQ9"
                    alt="pizza"
